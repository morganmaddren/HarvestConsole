...
{
    class SeasonFormatter : CardFormatter<SeasonCardData>
    {
        ...
        public override void Draw(Context context, XGraphics gfx, XRect bounds, SeasonCardData card, PrintOptions options)
        {
            ...
            DrawDebugRect(options, gfx, ScaleRect(SeasonRect, bounds));
            gfx.DrawString(card.Season.ToUpper(), SeasonFont, SeasonBrush, ScaleRect(SeasonRect, bounds), XStringFormats.Center);
