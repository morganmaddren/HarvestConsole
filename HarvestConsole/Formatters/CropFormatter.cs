...
{
    class CropFormatter : CardFormatter<CropCardData>
    {
        ...
        static readonly XPoint TitleCenter = new XPoint(1.25, 2.125);
        ...
        static readonly XPoint DewTitleCenter = new XPoint(.45, 2.125);
        static readonly XSize DewTitleSize = new XSize(.375, .375);
        ...
        {
            TryDrawImage(gfx, context.CardImageManager.GetImage(card.Id) ?? context.CardImageManager.GetImage("back"), ScaleRect(TemplateRect, bounds));
            TryDrawImage(gfx, context.CardImageManager.GetImage("screen"), ScaleRect(TemplateRect, bounds));

            TryDrawImage(gfx, context.TemplateManager.GetImage("h5_" + card.TemplateString), ScaleRect(TemplateRect, bounds));
            ...
            if (card.Offerings > 0)
            {
                ...
                gfx.DrawString(card.Offerings.ToString(), OfferingsFont, OfferingsBrush, ScaleRect(OfferingsTextRect, bounds), XStringFormats.Center);
            }
