...
{
    class CardFormatter<T> : ICardFormatter<T>, ICardFormatter where T : CardData
    {
        ...
        static readonly XRect IdRect = new XRect(.15, 3.5 - .05, 1.5, 0);
        static readonly XRect CountRect = new XRect(2.5 - .75, 3.5 - .05, 1.5, 0);
        ...
        protected static readonly XSize OfferingsSize = new XSize(.4, .4);
        protected static readonly XPoint OfferingsDefaultCenter = new XPoint(2.5 - .25, 3.5 - .25);
        protected static readonly XPoint OfferingsTextOffset = new XPoint(-.01, 0);

        protected static readonly XPoint SymbolCenter = new XPoint(1.25, 3.5 - .21);
        protected static readonly XSize SymbolSize = new XSize(.3, .3);
